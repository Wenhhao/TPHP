...
# 1.Data readin ------
# tphp <- rio::import(file.path(TPHP_HOME, 'results/rlt_combine_entraplib_G3/report.pro_matrix_full_0005LibQval_PGMaxLFQ.tsv'))
tphp <- arrow::read_parquet(file.path(TPHP_HOME, 'results/rlt_combine_entraplib_G3/report.pro_matrix_full_0005LibQval_PGMaxLFQ.parquet'))
